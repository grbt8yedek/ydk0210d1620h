...
-- User indexes
CREATE INDEX IF NOT EXISTS idx_user_lastlogin ON "User"("lastLoginAt");
CREATE INDEX IF NOT EXISTS idx_user_created ON "User"("createdAt");
CREATE INDEX IF NOT EXISTS idx_user_email ON "User"("email");

-- Reservation indexes
CREATE INDEX IF NOT EXISTS idx_reservation_created ON "Reservation"("createdAt");
...
CREATE INDEX IF NOT EXISTS idx_campaign_created ON "Campaign"("createdAt");

-- PriceAlert indexes
CREATE INDEX IF NOT EXISTS idx_pricealert_user ON "PriceAlert"("userId");
CREATE INDEX IF NOT EXISTS idx_pricealert_created ON "PriceAlert"("createdAt");

-- SearchFavorite indexes
CREATE INDEX IF NOT EXISTS idx_searchfavorite_user ON "SearchFavorite"("userId");
CREATE INDEX IF NOT EXISTS idx_searchfavorite_created ON "SearchFavorite"("createdAt");
